    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form id="template_form" id="template_form" method="POST" action="/resoluciones/{{$resolucion->id}}/actualizar"
                        ...
                        <input type="text" name="Nombres Apellidos Estudiante"
                            value="{{$estudiante->nombres}} {{$estudiante->apellidos}}" hidden>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-{{$field['type'] == 'marcar' || $field['type'] == 'tabla' ? 12 : 6 }}">
                                    <div class="form-group">
                                        {!! Form::label($field['label'], $field['label'], array('class' =>
                                        $field['type'] == 'marcar' ? 'font-weight-bold' : '')) !!}
                                        @if($field['type'] == 'select')
                                        {!! Form::{$field['type']}($field['label'], array_combine($field['options'],
                                        $field['options']), (isset($respuestas[preg_replace('~[ .]~', '_',
                                        $field['label'])]) ? $respuestas[preg_replace('~[ .]~', '_', $field['label'])]
                                        :null), array('class' => 'form-control ff', 'placeholder' => 'Seleccionar...',
                                        'required' => 'true')) !!}
                                        ...
                                        <div class="mx-4 mt-2">
                                            ...
                                            <div style class="form-check form-check-inline border p-2 rounded mb-2">
                                                ...
                                                (isset($respuestas[preg_replace('~[ .]~', '_', $field['label'])]) ?
                                                (strpos($respuestas[preg_replace('~[ .]~', '_', $field['label'])],
                                                $value['value']) !== false):false), array('class' => 'form-check-input
                                                mr-2 ff', 'required' => 'true')) !!}
                                                {!! Form::label($value['value'], $value['value'], array('class'=>
                                                'form-check-label')) !!}
                                            </div>
                                            @endforeach
                                        </div>
                                        ...
                                        <div>
                                            ...
                                            <div style class="form-check form-check-inline">
                                                ...
                                                (isset($respuestas[preg_replace('~[ .]~', '_', $field['label'])]) ?
                                                (strpos($respuestas[preg_replace('~[ .]~', '_', $field['label'])],
                                                $value) !== false):false), array('class' => 'form-check-input mr-2 ff',
                                                'required' => 'true')) !!}
                                        ...
                                        <div>
                                            ...
                                            <div style class="form-check form-check-inline">
                                                {!! Form::{$field['type']}($field['label'], $value,
                                                (isset($respuestas[preg_replace('~[ .]~', '_', $field['label'])]) ?
                                                $respuestas[preg_replace('~[ .]~', '_', $field['label'])]:null),
                                                array('class' => 'form-check-input mr-2 ff', 'required' => 'true')) !!}
                                                {!! Form::label($value, $value, array('class'=> 'form-check-label')) !!}
                                            </div>
                                            @endforeach
                                        </div>
                                        @elseif($field['type'] == 'cédula')
                                        {!! Form::text($field['label'], (isset($respuestas[preg_replace('~[ .]~', '_',
                                        $field['label'])]) ? $respuestas[preg_replace('~[ .]~', '_',
                                        $field['label'])]:null) , array('data-cedula'=>'true','class' => 'form-control
                                        ff', 'required' => 'true')) !!}
                                        @elseif($field['type'] == 'año')
                                        {!! Form::number($field['label'], (isset($respuestas[preg_replace('~[ .]~', '_',
                                        $field['label'])]) ? $respuestas[preg_replace('~[ .]~', '_',
                                        $field['label'])]:null) , array('data-año'=>'true','class' => 'form-control ff',
                                        'min' => 1950, 'max' => 2070, 'required' => 'true')) !!}
                                        @elseif($field['type'] == 'tabla')
                                        <div class="tablaContenedor">
                                            <input type="text" class="inputTabla" name="{{$field['label']}}" value=""
                                                hidden>
                                            ...
                                            {!! $respuestas[preg_replace('~[ .]~', '_', $field['label'])] !!}
                                        </div>
                                        @else
                                        ...
                                        (isset($respuestas[preg_replace('~[ .]~', '_', $field['label'])]) ?
                                        $respuestas[preg_replace('~[ .]~', '_', $field['label'])]:null) ,
                                        array('required' => 'true','class' => 'form-control ff'.($field['type'] ==
                                        'date' ? ' datefield' : ''))) !!}
                                        @endif
                                    </div>
                                </div>
