                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                value="{{ old('presidente') ?? $consejo->presidente}}" required>
                                    ...
                                    <option {{$consejo->presidente == $doce->nombres ? "selected" : ""}} >{{$doce->nombres}}</option>
                                    @endforeach
                                </select>
                            </div>
                                @error('presidente')
                            ...
                            <textarea name="miembros" class="form-control  @error('miembros') is-invalid @enderror" 
                            placeholder="Ingrese los mienbros del consejo" id="floatingTextarea2" 
                            style="height: 120px; font-size:13px">{{$consejo->miembros}}</textarea>
                            ...
                            <div class="col-12">
                                ...
                                <a class="btn btn-info" href="/consejos/{{$consejo->id}}/lote">
                                ...
                                <a class="btn btn-danger" href="/consejos/{{$consejo->id}}/lotePDF">
                                    Descargar Resoluciones
                    ...
                    <table class="table mt-3">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><a href="/resoluciones/{{$resolucion->id}}/descargar" class="btn btn-info">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-file-earmark-word" viewBox="0 0 16 16">
                                <path d="M5.485 6.879a.5.5 0 1 0-.97.242l1.5 6a.5.5 0 0 0 .967.01L8 9.402l1.018 3.73a.5.5 0 0 0 .967-.01l1.5-6a.5.5 0 0 0-.97-.242l-1.036 4.144-.997-3.655a.5.5 0 0 0-.964 0l-.997 3.655L5.485 6.88z"/>
                                <path d="M14 14V4.5L9.5 0H4a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2zM9.5 3A1.5 1.5 0 0 0 11 4.5h2V14a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1h5.5v2z"/>
                                </svg>
                                    </a>
                                    <a href="/resoluciones/{{$resolucion->id}}/descargarPDF" class="btn btn-danger">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-file-earmark" viewBox="0 0 16 16">
                                    <path d="M14 4.5V14a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V2a2 2 0 0 1 2-2h5.5L14 4.5zm-3 0A1.5 1.5 0 0 1 9.5 3V1H4a1 1 0 0 0-1 1v12a1 1 0 0 0 1 1h8a1 1 0 0 0 1-1V4.5h-2z"/>
                                    </svg>
                                 </a>
                                    ...
                                    @if ($consejo->estado == 'ENPROCESO')
                                    <a href="/resoluciones/{{$resolucion->id}}/editar" class="btn btn-success">
                                    ...
                                    <form style="display: inline-block" method="POST"
                                        ...
                                        @csrf
                                        @method('delete')
                                        <button type="submit" class="btn btn-warning boton_eliminar">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
