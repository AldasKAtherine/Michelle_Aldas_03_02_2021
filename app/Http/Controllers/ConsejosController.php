...
class ConsejosController extends Controller
{
    ...
    public function create() {
        ...
        return view('consejos.create',['docentes'=>$docentes]);
    }
    ...
    public function store(Request $request){
        $data = $request->validate([
            ...
            'miembros'=>['required','string','min:300']
        ], [
    ...
    public function descargarActa(Request $request, $id)
    {
        ...
        $plantillaActa->setValue('Miembros',$consejo->miembros);
    ...
    public function descargarLotePDF(Request $request, $id)
    {
