...
class ResolucionesController extends Controller
{
    ...
    public function resolucionesConsejos($idConsejo){
        $resoluciones = Resolucion::where('consejo_id',$idConsejo)->get();
    ...
    public function descargarPDF(Request $request, $id){
        ...
        $h = $templateProcessor->save(public_path()."/h.docx");    

        //dd(base_path().'\vendor\dompdf\dompdf');
