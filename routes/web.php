...
Route::get('/consejos/{consejo}/lote', 'ConsejosController@descargarLote')->middleware('auth', 'role:ABOGADO', 'banned');
Route::get('/consejos/{consejo}/lotePDF', 'ConsejosController@descargarLotePDF')->middleware('auth', 'role:ABOGADO', 'banned');
...
Route::get('/docentes', 'DocentesControllerKMAM@index')->middleware('auth', 'role:ADMINISTRADOR', 'banned');

Route::post('/importKMAM-list-excel','DocentesControllerKMAM@importExcelKMAM')->middleware('auth', 'role:ADMINISTRADOR', 'banned')->name('docentes.import.excel');

Route::get('/resoluciones/{id}/descargarPDF', 'ResolucionesController@descargarPDF')->middleware('auth', 'role:ABOGADO|AYUDANTE', 'banned');